    ...
    return (
        <Grid container sx={classes.container}>
            ...
            <Button color='inherit' sx={{ m: 1, textTransform: 'none' }}>
                <Grid item display='flex' ><GoogleIcon sx={{ color: '#5375e2' }} /><Typography sx={classes.myLabels}>Login with Google</Typography></Grid>
            </Button>
            ...
            <Button variant="contained" color='primary' sx={{ textTransform: 'none' }}><Typography sx={{ fontFamily: 'Varela Round', fontSize: '1rem' }}>Sign Up</Typography></Button>
